...
set xlabel "Paths"
set ylabel "sec (10percent-median-90percent)"
...
plot "../parsed_data/OLSRv1-IPv6-ping.txt" every ::1 u 0:3 with boxes title "OLSRv1" lw 3,\
"../parsed_data/OLSRv2-IPv6-ping.txt" every ::1 u ($0+0.1):3 with boxes title "OLSRv2" lw 3,\
"../parsed_data/BATMAN4-IPv6-ping.txt" every ::1 u ($0+0.2):3 with boxes title "BATMAN4" lw 3,\
"../parsed_data/BATMAN5-IPv6-ping.txt" every ::1 u ($0+0.3):3 with boxes title "BATMAN5" lw 3,\
"../parsed_data/BABEL-IPv6-ping.txt" every ::1 u ($0+0.4):3 with boxes title "BABEL" lw 3,\
"../parsed_data/BMX7-IPv6-ping.txt" every ::1 u ($0+0.5):3 with boxes title "BMX7" lw 3
