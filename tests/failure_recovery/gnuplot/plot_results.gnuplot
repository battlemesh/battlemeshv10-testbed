...
"../parsed_data/BABEL-IPv4.txt" every ::1 u ($0+0.3):5:4:6:5 with candlesticks title "BABEL" lw 3
...
"../parsed_data/BABEL-IPv6.txt" every ::1 u ($0+0.3):5:4:6:5 with candlesticks title "BABEL" lw 3
