...
plot "../parsed_data/OLSRv1-IPv6-iperf-noairfair.txt" i 0 u ($0*2):3:4:5:6 with candlesticks title "OLSRv1 {NA}" lw 3,\
"../parsed_data/OLSRv1-IPv6-iperf.txt" i 0 u ($0*2+0.1):3:4:5:6 with candlesticks title "OLSRv1" lw 3,\
"../parsed_data/OLSRv2-IPv6-iperf-noairfair.txt" i 0 u ($0*2+0.2):3:4:5:6 with candlesticks title "OLSRv2 {NA}" lw 3,\
"../parsed_data/OLSRv2-IPv6-iperf.txt" i 0 u ($0*2+0.3):3:4:5:6 with candlesticks title "OLSRv2" lw 3,\
"../parsed_data/OLSRv2_MPR-IPv6-iperf-noairfair.txt" i 0 u ($0*2+0.4):3:4:5:6 with candlesticks title "OLSRv2_{MPR}{NA}" lw 3,\
"../parsed_data/OLSRv2_MPR-IPv6-iperf.txt" i 0 u ($0*2+0.5):3:4:5:6 with candlesticks title "OLSRv2_{MPR}" lw 3,\
"../parsed_data/BABEL-IPv6-iperf-noairfair.txt" i 0 u ($0*2+0.6):3:4:5:6 with candlesticks title "BABEL {NA}" lw 3,\
"../parsed_data/BABEL-IPv6-iperf.txt" i 0 u ($0*2+0.7):3:4:5:6 with candlesticks title "BABEL" lw 3,\
"../parsed_data/BMX7-IPv6-iperf-noairfair.txt" i 0 u ($0*2+0.8):3:4:5:6 with candlesticks title "BMX7 {NA}" lw 3,\
"../parsed_data/BMX7-IPv6-iperf.txt" i 0 u ($0*2+0.9):3:4:5:6 with candlesticks title "BMX7" lw 3,\
"../parsed_data/BMX7TUN-IPv6-iperf-noairfair.txt" i 0 u ($0*2+1):3:4:5:6 with candlesticks title "BMX7TUN {NA}" lw 3,\
"../parsed_data/BMX7TUN-IPv6-iperf.txt" i 0 u ($0*2+1.1):3:4:5:6 with candlesticks title "BMX7TUN" lw 3,\
"../parsed_data/BATMAN4-IPv6-iperf-noairfair.txt" i 0 u ($0*2+1.2):3:4:5:6 with candlesticks title "BATMAN4 {NA}" lw 3,\
